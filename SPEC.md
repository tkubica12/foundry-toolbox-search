...
- Toolbox configuration adds extra search text for loan balance, mortgage affordability, current-account KYC/balance, and investment portfolio-summary tools so Tool Search can distinguish similar capabilities.
